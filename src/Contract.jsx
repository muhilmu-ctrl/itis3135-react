export default function Contract(){
    return (
        ...
        <p>I, Muhilan Muruganandam, agree to abide by the terms of the course contract in my FALL 2025, ITIS3135, Front-End Web App Development with my instructor, Professor D.I. von Briesen.
            ...
            I understand that all work that I do on publicly available online tools will bw available to the world, and will not put information there that is inappropriate for schoolwork, or tat I wish to keep private.

            I also understand that it is my work that counts for attendence, not logins or showing up for class. As such failire to tun in assignments may show as absences.
